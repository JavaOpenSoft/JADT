...
import juit.Layouts.*;
import juit.Layouts.GridBagLayout;
import juit.Layouts.GridLayout;
import juit.Layouts.SpringLayout;
...
public class Window implements juit.Core.Constants.WindowConstants{
    ...
    public void setLayout(GridLayout gridLayouts)
    {
        window.setLayout(gridLayouts.getLayout());
    }
    public void setLayout(SpringLayout springLayouts)
    {
